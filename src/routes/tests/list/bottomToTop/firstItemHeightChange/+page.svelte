...
<div class="page">
    <div class="demo-shell">
        <div class="stats-panel" data-testid="bottom-to-top-height-stats">
            <div class="stats-header">
                <div>
                    <div class="eyebrow">BottomToTop FirstItemHeightChange</div>
                    <h1>Height changes: {JSON.stringify(heightChanges)}</h1>
                </div>
