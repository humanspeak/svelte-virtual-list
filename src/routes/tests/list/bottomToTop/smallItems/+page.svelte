<script lang="ts">
    ...
    type LocalItem = Item & { height: number }

    const items: LocalItem[] = $state([
    ...
    let virtualList = $state<SvelteVirtualList<LocalItem> | null>(null)
...
<div class="page">
    <div class="demo-shell">
        <div class="stats-panel" data-testid="bottom-to-top-small-stats">
            <div class="stats-header">
                <div>
                    <div class="eyebrow">BottomToTop SmallItems</div>
                    <h1>2 items, 500px viewport.</h1>
                </div>
